...
class StudentProfile {
    ...
    final dynamic studentPicture;
    final String? standard;
    final String? section;
    final String? admissionNo;
    final String? dob;
    final dynamic studentMobileNumber;
    ...
    final dynamic classTeacherName;
    ...
    StudentProfile copyWith({
        ...
        String? studentName,
        dynamic studentPicture,
        String? standard,
        String? section,
        String? admissionNo,
        String? dob,
        dynamic studentMobileNumber,
        String? address,
        int? sessionId,
